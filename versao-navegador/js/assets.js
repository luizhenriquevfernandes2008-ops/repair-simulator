...
(function () {
  ...
  const MODELS = {
    ...
    // --- rua (cutscenes) ---
    st_ours: { file: 'st_bld1', rot: [0, 0, 0], size: 7 },
    st_rival: { file: 'st_bld2', rot: [0, 0, 0], size: 7 },
    st_large: { file: 'st_large', rot: [0, 0, 0], size: 9 },
    st_small: { file: 'st_small', rot: [0, 0, 0], size: 8 },
    st_light: { file: 'st_light', rot: [0, 0, 0], size: 5.5, fit: 'y' },
    st_car: { file: 'st_car', rot: [0, 0, 0], size: 4.2 },
    st_car2: { file: 'st_car2', rot: [0, 0, 0], size: 4.4 },
    st_police: { file: 'st_police', rot: [0, 0, 0], size: 4.6 },
    st_tree: { file: 'st_tree', rot: [0, 0, 0], size: 4.5, fit: 'y' },
    st_bench: { file: 'st_bench', rot: [0, 0, 0], size: 2.2 },
    st_street: { file: 'st_street', rot: [0, 0, 0], size: 12 },
    st_cross: { file: 'st_cross', rot: [0, 0, 0], size: 12 },
    st_busstop: { file: 'st_busstop', rot: [0, 0, 0], size: 4 },
    // --- eventos ---
